...
<body>
<h1 style="color: #4BC0A5">郑州财经学院校园跳蚤市场<sup>2021</sup></h1>
                    ...
                    <form action="login" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm"
                        ...
                        <div class="uinArea" id="uinArea">
                            ...
                            <div class="inputOuter" id="uArea">
                                <input type="text" id="login-son" name="sno" class="inputstyle" value=""/>
                            </div>
                        </div>
                ...
                <ul class="reg_form" id="reg-ul">
                    ...
                    <li>
                        ...
                        <div class="inputOuter2">
                            <input type="text" id="user-sno" name="sno" maxlength="18" class="inputstyle2"/>
                        </div>
                    </li>
                    <li>
                        <label for="passwd" class="input-tips2">密码：</label>
                        <div class="inputOuter2">
                            <input type="password" id="password"  name="password" maxlength="18" class="inputstyle2"/>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="inputOuter2">
                            <input type="password" id="password2" name="" maxlength="18" class="inputstyle2" />
                        </div>
