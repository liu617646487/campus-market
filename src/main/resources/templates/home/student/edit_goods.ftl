...
<div class="container">
    <div class="main center">
        ...
        <div class="release-title">编辑商品</div>
            ...
            <div class="form-wr">
                <div class="form-must-wr">
                    ...
                    <div id="show-img" class="form-item l goods-title" style="height: 100px;">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <img id="upload-img" src="/photo/view?filename=${goods.photo}" width="100px" height="100px"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-item xl goods-desc">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <textarea name="content" id="desc" placeholder="建议填写物品用途、新旧程度、原价等信息，至少15个字" minlength="15" class="required" tips="请填写商品详情描述">${goods.content}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-item l goods-price">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="price required" id="buyPrice" name="buyPrice" value="${goods.buyPrice}" type="number" tips="请填写购入价格"></div>
                        </div>
                    </div>
                    <div class="form-item l goods-price">
                        <div class="form-key">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="price required" id="sellPrice" name="sellPrice" value="${goods.sellPrice}" type="number" tips="请上填写出售价格"></div>
                        </div>
                    </div>
                            ...
                            <div class="form-input-wr">
                                ...
                                <select id="cid2" name="goodsCategory" style="width: 40%;height: 28px;color: rgb(68, 68, 68);font-size: 1.17em;line-height: 28px;vertical-align: middle;background-color: transparent;" class="required" tips="请选择分类">
                                    ...
                                    <#if goodsCategories??>
                                        <#list goodsCategories as goodsCategory>
                                            <#if goodsCategory.parent??>
                                                <#if goods.goodsCategory.parent.id==goodsCategory.parent.id>
    ...
    $(document).ready(function(){
        ...
        $("#submit-btn").click(function () {
            ...
            if (flag){
                ...
                ajaxRequest('edit_goods','post',data, function () {
