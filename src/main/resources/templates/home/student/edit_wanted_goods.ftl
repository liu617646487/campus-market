                ...
                <div class="form-wr">
                    <div class="form-must-wr">
                        ...
                        <div class="form-item xl goods-desc">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <textarea name="content" id="desc" placeholder="建议填写购买物品用途、新旧程度、原价等信息，至少15个字" minlength="15" class="required" tips="请填写商品详情描述">${wantedGoods.content}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-item l goods-title">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input class="required" id="tradePlace" name="tradePlace" value="${wantedGoods.tradePlace}" type="text" tips="请填写期望交易地点">
                                </div>
                            </div>
                        </div>
                        <div class="form-item l goods-price">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input class="price required" id="sellPrice" name="sellPrice" value="${wantedGoods.sellPrice}" type="number" tips="请上填写期望价格">
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function(){
            ...
            $("#submit-btn").click(function () {
                ...
                if (flag){
                    ...
                    ajaxRequest('edit_wanted_goods','post',data, function () {
