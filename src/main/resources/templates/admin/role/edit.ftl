...
<head>
    ...
    <title>角色管理|${title!""} - ${siteName!""}</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form id="role-edit-form" action="edit" method="post" class="row">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="status" value="1" <#if role.status==1>checked</#if> ><span>启用</span>
                                        </label>
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="status" value="0" <#if role.status==0>checked</#if> ><span>不启用</span>
                                        </label>
                                    </div>
