                            ...
                            <div class="card-body">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as wantedGoods>
                                                ...
                                                <tr align="center">
                                                    ...
                                                    <td style="vertical-align: middle">${wantedGoods.name!""}</td>
                                                    <td style="vertical-align: middle">${wantedGoods.student.sno!""}</td>
                                                    <td style="vertical-align: middle">${wantedGoods.sellPrice!""}</td>
                                                    <td style="vertical-align: middle">${wantedGoods.tradePlace!""}</td>
                                                    <td style="vertical-align: middle">${wantedGoods.viewNumber!""}</td>
                                                    <td style="vertical-align: middle">${wantedGoods.createTime!""}</td>
                                                </tr>
                                ...
                                <#if pageBean.total gt 0 >
                                    <ul class="pagination">
                                        ...
                                        <#else>
                                            <li><a href="list?<#if sno??>student.sno=${sno}<#elseif name??>name=${name}</#if>&currentPage=1">«</a></li>
                                        </#if>
                                        <#list pageBean.currentShowPage as showPage>
                                            <#if pageBean.currentPage==showPage>
                                                <li class="active"><span>${showPage}</span></li>
                                            <#else>
                                                <li><a href="list?<#if sno??>student.sno=${sno}<#elseif name??>name=${name}</#if>&currentPage=${showPage}">${showPage}</a></li>
                                            </#if>
                                        </#list>
                                        <#if pageBean.currentPage==pageBean.totalPage>
                                            <li class="disabled"><span>»</span></li>
                                        <#else>
                                            <li><a href="list?<#if sno??>student.sno=${sno}<#elseif name??>name=${name}</#if>&currentPage=${pageBean.totalPage}">»</a></li>
                                        </#if>
