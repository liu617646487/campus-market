                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="goodscategory-edit-form" action="edit" method="post" class="row">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" class="form-control required" id="icon" name="icon" value="${goodsCategory.icon}" placeholder="请选择菜单icon" tips="请选择菜单icon" readonly/>
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" class="form-control required" id="name" name="name" value="${goodsCategory.name}" placeholder="请输入物品分类名" tips="请填写物品分类名！"/>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function(e) {
        ...
        $("#edit-form-submit-btn").click(function () {
            ...
            var data=$("#goodscategory-edit-form").serialize();
            $.ajax({
                url: 'edit',
                type: 'post',
                data: data,
                ...
                success:function (data) {
                    if(data.code==0){
                        ...
                        showSuccessMsg("物品分类编辑成功!",function () {
