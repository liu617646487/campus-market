                ...
                <div class="row">
                        ...
                        <div class="card bg-primary">
                            <div class="card-body clearfix">
                                <div class="pull-right">
                                    ...
                                    <p class="h3 text-white m-b-0">${databaseBakTotal!"0"}</p>
                                </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-success">
                            <div class="card-body clearfix">
                                <div class="pull-right">
                                    <p class="h6 text-white m-t-0">当前在线用户数</p>
                                    <p class="h3 text-white m-b-0">${onlineUserTotal!""}</p>
                                </div>
                        ...
                        <div class="card bg-purple">
                            <div class="card-body clearfix">
                                <div class="pull-right">
                                    ...
                                    <p class="h3 text-white m-b-0">${operatorTotal!"0"}</p>
                                </div>
