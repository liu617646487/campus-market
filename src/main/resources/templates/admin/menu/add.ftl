                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form id="menu-add-form" action="add" method="post" class="row">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="isbutton" value="true" ><span>是</span>
                                        </label>
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="isbutton" value="false" checked><span>否</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="input-group m-b-10">
                                        是否显示：
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="isshow" value="true" checked><span>是</span>
                                        </label>
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="isshow" value="false" ><span>否</span>
                                        </label>
                                    </div>
