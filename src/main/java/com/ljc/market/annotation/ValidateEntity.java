package com.ljc.market.annotation;
...
public @interface ValidateEntity {
    ...
    public boolean requiredLength() default false;//是否检长度
    ...
    public String errorMaxLengthMsg() default "";//最大长度不满足时的错误提示信息

    public String errorMinLengthMsg() default "";//最小长度不满足时的错误提示信息

    public String errorMaxValueMsg() default "";//最大值不满足时的错误提示信息

    public String errorMinValueMsg() default "";//最小值不满足时的错误提示信息
